...
class Logo {
    ...
    addShape() {
        switch (this.shape) {
            ...
            case "Square": 
                ...
                square.render();
                return this.shapeElement = square;
        }
    ...
    addText() {
        switch(this.shape) {
            ...
            case "Square":
                return this.textElement.templateLiteral = `<text x="140" y="115" font-size="48" text-anchor="middle" fill="${this.textColor}">${this.text}</text>`
