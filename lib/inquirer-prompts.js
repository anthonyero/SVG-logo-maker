...
const questions = [
    ...
    {
        type: "input",
        message: "What color would you like to use for your logo? Please provide a color keyword or a hexadecimal number (with #):",
        name: "logoColor",
...
const runInquirer = () => {
    ...
    .then((response) => {
        const logoObject = new logo.Logo(response.logoText, response.logoShape, response.logoColor);
        logoObject.render()
    })
}
